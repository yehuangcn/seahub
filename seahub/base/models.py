...
from seahub.utils import calc_file_path_hash, within_time_range, gen_token
...
class ClientSSOToken(models.Model):
    ...
    email = LowerCaseCharField(max_length=255, db_index=True, blank=True,
                               null=True)
    status = models.CharField(max_length=10, default=STATUS_WAITING,
